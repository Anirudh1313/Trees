...
private:
    ...
    void printData(int level, int offset, BinaryNode *levelNodes[]);
    void printOutgoingPointers(int level, int offset, BinaryNode *levelNodes[]);
    void printConnectingDashes(int level, int offset, BinaryNode *levelNodes[]);
    void printIncomingPointers(int level, int offset, BinaryNode *levelNodes[]);
